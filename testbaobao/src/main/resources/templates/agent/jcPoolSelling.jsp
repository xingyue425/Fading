...
.bs-docs-example:after {
	...
	color: #9DA0A4;
	content: "游戏 > 查询竞彩在售奖池(agent-A2007)";
	font-size: 12px;
	font-weight: bold;
	left: -1px;
	padding: 3px 7px;
...
<body>
	...
	<form class="bs-docs-example form-horizontal" id="inputForm">
			...
			<div class="control-group">
				<label for="version" class="control-label">代销者奖池版本号</label>
				<div class="controls">
			...
			<div class="control-group">
				<div class="controls">
					<button class="btn btn-primary" type="button" onclick="$.ajaxSubmit('${ctx}/jcPoolSelling/submit');">查询</button>
				</div>
			</div>
	</form>
